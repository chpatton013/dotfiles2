...
`organizing-workspace` skill before proceeding — it defines the convention
these phases depend on and covers first-time setup and how to recognize an
...
- Read `AGENTS.md` conventions and use the relevant **skill** for each task
  (`.agents/skills/...` or the shared agent-craft skills, whichever applies).
